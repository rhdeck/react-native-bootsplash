...
<layer-list xmlns:android="http://schemas.android.com/apk/res/android" android:opacity="opaque">
    ...
    <item>
        <bitmap android:src="@drawable/${logoFileName}" android:gravity="center" />
    </item>
</layer-list>
`;
...
async function generate({
  ...
  if (fs.existsSync(androidResPath)) {
    ...
    imageMap.push(
      [path.join(androidResPath, "drawable-mdpi", fileName), [w1, h(w1)]],
      [path.join(androidResPath, "drawable-hdpi", fileName), [w15, h(w15)]],
      [path.join(androidResPath, "drawable-xhdpi", fileName), [w2, h(w2)]],
      [path.join(androidResPath, "drawable-xxhdpi", fileName), [w3, h(w3)]],
      [path.join(androidResPath, "drawable-xxxhdpi", fileName), [w4, h(w4)]],
    );
  } else {
